export default {
  ...
  'resources.preheat.policy.disabled.profileStale': 'S3 配置版本已变化，请先重新协调策略。',
  ...
  'resources.preheat.confirm.flow.workers': '{model} -> S3 配置 {profile} -> 目标节点',
  'resources.preheat.confirm.flow.artifact': '固定 S3 Artifact {model} -> 本集群目标节点',
