export default {
  ...
  'resources.preheat.workerRole': '角色',
  'resources.preheat.workerRole.seed': '预热',
  'resources.preheat.workerRole.distribute': '分发',
  'resources.preheat.workerRole.connectivity_check': '连通性',
  ...
  'resources.preheat.deliveryMode': '交付方式',
  'resources.preheat.delivery.s3_only': '仅发布到 S3',
  'resources.preheat.delivery.s3_and_workers': '发布到 S3 并分发到节点',
  'resources.preheat.connectivity.createAnyway': '仍然创建',
  ...
  'resources.preheat.disabledByServer':
    '当前服务未启用模型预热，无法新建或立即执行预热策略',
  'resources.preheat.capabilityChecking': '正在检查服务端模型预热能力',
  'resources.preheat.capabilityLoadFailed':
    '无法确认服务端是否支持模型预热，相关操作已暂时禁用',
  ...
  'resources.preheat.schedule.triggerMode.continuous': '持续补齐',
  ...
  'resources.storage.sync.unsupportedSource': '此来源不受 S3 同步支持。',
  ...
  'resources.storage.workerProtocolMissing': '节点未上报同步协议版本。',
  ...
  'resources.preheat.policy.disabled.profileStale':
    'S3 配置版本已变化，请先重新协调策略。',
  'resources.preheat.policy.disabled.blocked': '服务端当前阻止启用：{reason}',
  ...
  'resources.storage.connectionTest.scope': '检测范围',
  'resources.storage.connectionTest.scope.server': '服务端到 S3',
  'resources.storage.connectionTest.stage.connection': '网络连接',
  'resources.storage.connectionTest.stage.bucket': 'Bucket 访问',
  'resources.storage.connectionTest.stage.write': '写入',
  'resources.storage.connectionTest.stage.read': '读取',
  'resources.storage.connectionTest.stage.delete': '清理测试对象',
  'resources.storage.connectionTest.ok': '通过',
  'resources.storage.error.notReached': '前置检测未通过，未执行此阶段',
  'resources.storage.error.invalidEndpoint': 'Endpoint 协议或地址无效',
  'resources.storage.error.forbiddenAddress': 'Endpoint 解析到禁止访问的地址',
  'resources.storage.error.dnsTimeout': 'DNS 解析超时',
  'resources.storage.error.dnsFailed': 'DNS 解析失败',
  'resources.storage.error.tcpFailed': 'TCP 连接失败',
  'resources.storage.error.tlsVerifyFailed': 'TLS 证书校验失败',
  'resources.storage.error.tlsHandshakeFailed': 'TLS 握手失败',
  'resources.storage.error.redirectForbidden': 'S3 返回了不允许的重定向',
  'resources.storage.error.authenticationFailed': 'S3 身份认证失败',
  'resources.storage.error.requestFailed': 'S3 请求失败',
  'resources.storage.error.clientInitializationFailed': 'S3 客户端初始化失败',
  'resources.storage.error.readContentMismatch': '读取内容与写入内容不一致',
  ...
  'resources.storage.artifact.includeFilterNotSpecified': '未指定包含过滤',
  'resources.storage.artifact.excludeFilterNotSpecified': '未指定排除过滤',
  'resources.storage.artifact.includeFilterPattern': '请求包含模式',
  'resources.storage.artifact.excludeFilterPattern': '请求排除模式',
  'resources.storage.artifact.ggufFilterPattern': 'GGUF 请求过滤模式',
  'resources.storage.artifact.requestedQuantizationHint': '请求包含/量化提示',
  'resources.storage.artifact.fixedDistributionHint':
    '实际分发固定整个模型，不支持单选包内精度',
  'resources.storage.artifact.resolving': '正在验证模型是否属于当前 S3 配置',
  'resources.storage.artifact.unresolved': '请选择当前 S3 配置中的有效模型',
  ...
  'resources.storage.testCredentialsRequiredHint':
    '请先更新凭据并填写访问密钥和秘密密钥，再测试连接。',
  'resources.storage.sync.confirmSummary':
    '摘要相同的模型内容会跳过；摘要不一致的文件会被覆盖。',
  'resources.preheat.confirm.title': '确认创建',
  'resources.preheat.confirm.flow': '最终流向',
  'resources.preheat.confirm.flow.s3Only': '{model} -> S3 配置 {profile}',
  ...
  'resources.preheat.confirm.artifactSize': 'S3 模型大小',
  'resources.preheat.confirm.skipRule': '跳过规则',
  'resources.preheat.confirm.skipRuleValue': '摘要相同的文件会跳过。',
  'resources.preheat.confirm.conflictRule': '覆盖/冲突规则',
  'resources.preheat.confirm.conflictRuleValue':
    '摘要不一致的文件会覆盖；冲突由后端按幂等与 lease 规则处理。',
  'resources.preheat.confirm.conflictRuleValue.s3_only':
    '同一 Artifact ID 的内容冲突会隔离或失败，不会覆盖共享 S3 Artifact。',
  'resources.preheat.confirm.conflictRuleValue.workers':
    '目标节点上摘要不一致的文件会按后端幂等与 lease 规则替换。',
  'resources.preheat.confirm.conflictRuleValue.artifact':
    '固定 Artifact 只向目标节点安装；节点文件冲突由后端幂等与 lease 规则处理。',
  'resources.storage.taskProgress': '进度',
  'resources.storage.startedAt': '开始时间',
  'resources.storage.finishedAt': '完成时间',
  'resources.storage.taskTimeline': '阶段时间线',
  'resources.preheat.schedule.preset.manual': '手动',
  'resources.preheat.schedule.preset.hourly': '每小时',
  'resources.preheat.schedule.preset.daily': '每天',
  'resources.preheat.schedule.preset.weekly': '每周',
  'resources.preheat.schedule.preset.custom': '自定义 Cron',
  'resources.preheat.schedule.time': '执行时间',
  'resources.preheat.schedule.weekday': '星期',
  'resources.preheat.schedule.weekday.0': '星期日',
  'resources.preheat.schedule.weekday.1': '星期一',
  'resources.preheat.schedule.weekday.2': '星期二',
  'resources.preheat.schedule.weekday.3': '星期三',
  'resources.preheat.schedule.weekday.4': '星期四',
  'resources.preheat.schedule.weekday.5': '星期五',
  'resources.preheat.schedule.weekday.6': '星期六',
  'resources.preheat.schedule.preset.continuous': '持续补齐',
  'resources.preheat.schedule.summary.label': '计划摘要',
  'resources.preheat.schedule.summary.manual': '手动执行',
  'resources.preheat.schedule.summary.continuous': '持续补齐',
  'resources.preheat.schedule.summary.hourly': '每小时执行',
  'resources.preheat.schedule.summary.daily': '每天 {time} 执行',
  'resources.preheat.schedule.summary.weekly': '每周 {weekday} {time} 执行',
  'resources.preheat.schedule.summary.custom': '自定义 Cron：{cron}',
  'resources.preheat.schedule.nextRuns': '未来三次执行',
  'resources.preheat.schedule.nextRunsUnavailable': '无法在客户端预览',
  'resources.storage.totalSize': '总容量',
  'resources.storage.stateMessage': '状态说明',
  'resources.storage.taskState.paused': '已暂停',
  'resources.storage.taskState.partial': '部分完成',
  'resources.storage.taskState.unknown': '未知状态',
  'resources.storage.syncTask.state.running': '执行中',
  ...
  'resources.storage.distributionPolicy.selectionMode.selected': '指定多个模型',
  'resources.storage.distributionPolicy.selectionMode.all_current':
    '全部当前有效模型',
  'resources.storage.distributionPolicy.artifacts': 'S3 模型',
  'resources.storage.distributionPolicy.structureLocked':
    '该策略已经执行，模型范围、Profile 和目标节点不可修改；名称与执行计划仍可调整。',
  'resources.storage.distributionPolicy.confirm.allCurrent':
    '使用 {profile} 中全部当前有效模型',
  'resources.storage.distributionPolicy.confirm.selected':
    '使用 {profile} 中选定的 {count} 个模型',
  'resources.storage.distributionPolicy.latestRun': '最近运行',
  'resources.storage.distributionPolicy.notExecuted': '尚未执行',
  'resources.storage.distributionPolicy.execution.waiting': '等待中',
  'resources.storage.distributionPolicy.execution.running': '执行中',
  'resources.storage.distributionPolicy.execution.paused': '已暂停',
  'resources.storage.distributionPolicy.execution.ready': '已完成',
  'resources.storage.distributionPolicy.execution.partial_error': '部分失败',
  'resources.storage.distributionPolicy.execution.error': '失败',
  'resources.storage.distributionPolicy.execution.skipped': '已跳过',
  'resources.storage.distributionPolicy.progress': '汇总进度',
  'resources.storage.distributionPolicy.progressCount':
    '完成 {completed}/{total}',
  'resources.storage.distributionPolicy.latestError': '最近错误',
  'resources.storage.distributionPolicy.runTimes': '运行时间',
  'resources.storage.distributionPolicy.lastRunAt': '上次运行',
  'resources.storage.distributionPolicy.nextRunAt': '下次运行',
  'resources.storage.distributionPolicy.runDetail': '运行详情',
  'resources.storage.distributionPolicy.executionState': '执行状态',
  'resources.storage.distributionPolicy.startedAt': '开始时间',
  'resources.storage.distributionPolicy.finishedAt': '完成时间',
  'resources.storage.distributionPolicy.worker': '节点',
  'resources.storage.distributionPolicy.failureReason': '失败原因',
  'resources.storage.distributionPolicy.taskState.pending': '等待中',
  'resources.storage.distributionPolicy.taskState.running': '执行中',
  'resources.storage.distributionPolicy.taskState.paused': '已暂停',
  'resources.storage.distributionPolicy.taskState.ready': '已完成',
  'resources.storage.distributionPolicy.taskState.error': '失败',
  'resources.storage.distributionPolicy.taskState.canceled': '已取消',
  'resources.storage.distributionPolicy.taskState.skipped': '已跳过',
  'resources.storage.distributionPolicy.taskState.skipped_worker_removed':
    '已跳过（节点已移除）',
  'resources.storage.distributionPolicy.taskState.unknown': '未知状态'
};
