export default {
  ...
  'resources.storage.workerProtocolMissing': 'Worker から同期プロトコルのバージョンが報告されていません。',
  ...
  'resources.preheat.policy.disabled.profileStale': 'S3 プロファイルのバージョンが変更されています。先にポリシーを再調整してください。',
  'resources.preheat.policy.disabled.blocked': 'サーバーが現在有効化をブロックしています: {reason}',
  ...
  'resources.preheat.confirm.flow.s3Only': '{model} -> S3 プロファイル {profile}',
  'resources.preheat.confirm.flow.workers': '{model} -> S3 プロファイル {profile} -> 対象 Worker',
  'resources.preheat.confirm.flow.artifact': '固定 S3 Artifact {model} -> このクラスターの対象 Worker',
  ...
  'resources.preheat.confirm.capacityUnavailable': 'Worker から容量情報が報告されていません',
  'resources.preheat.confirm.artifactSize': 'S3 モデルサイズ',
  'resources.preheat.confirm.skipRule': 'スキップ規則',
  'resources.preheat.confirm.skipRuleValue': '同じダイジェストのファイルはスキップされます。',
