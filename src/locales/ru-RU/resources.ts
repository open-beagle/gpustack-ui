export default {
  ...
  'resources.storage.syncTask.error.worker_execution_failed': 'Воркер не смог выполнить задачу синхронизации',
  'resources.storage.syncTask.error.manifest_invalid': 'Недопустимый манифест модели',
  'resources.storage.syncTask.error.s3_object_conflict': 'Объект модели конфликтует с существующим объектом в S3',
  ...
  'resources.storage.sync.noDefault': 'Нет доступного активного профиля S3 по умолчанию. Сначала назначьте профиль по умолчанию.',
  'resources.storage.sync.alreadyFromDefault': 'Эта модель уже получена из S3-библиотеки моделей по умолчанию, повторная синхронизация не требуется.',
  'resources.storage.sync.missingRevision': 'У этой устаревшей модели нет доверенных данных о версии. Загрузите ее повторно перед синхронизацией с S3.',
  'resources.storage.revision.modelscopeFilelist': 'Отпечаток списка файлов {fingerprint}',
  'resources.preheat.noReadyWorkers': 'Нет Ready-воркеров для проверки подключения.',
  ...
  'resources.storage.syncBatch.description.single_model': 'Загрузить существующую модель выбранного Ready-воркера в целевой S3. Модель не будет разослана на другие воркеры.',
  'resources.storage.syncBatch.description.selected_workers': 'Загрузить существующие модели выбранных Ready-воркеров в целевой S3. Они не будут разосланы на другие воркеры.',
  'resources.storage.syncBatch.description.all_ready_workers': 'Загрузить существующие модели всех Ready-воркеров в целевой S3. Они не будут разосланы на другие воркеры.',
  'resources.storage.syncBatch.selectWorker': 'Выберите воркер',
  'resources.storage.syncBatch.selectModel': 'Выберите модель',
  'resources.storage.syncBatch.noSyncableModels': 'На этом воркере нет готовых к синхронизации моделей.',
  ...
  'resources.storage.syncBatch.reason.duplicate_artifact_identity': 'Та же версия модели уже запланирована с другого Ready-воркера',
  'resources.storage.syncBatch.reason.active_task_exists': 'Задача синхронизации уже выполняется',
  'resources.storage.syncBatch.reason.model_file_not_found': 'Модель не существует',
  ...
  'resources.storage.createStrategy': 'Создать стратегию из этой записи синхронизации',
  ...
  'resources.preheat.schedule.bandwidth': 'Лимит пропускной способности (Мбит/с)',
  ...
  'resources.preheat.schedule.enableConfirm': 'Включить стратегию по расписанию',
  ...
  'resources.storage.workerProtocolMissing': 'Worker не сообщает версию протокола синхронизации.',
  ...
  'resources.preheat.policy.disabled.profileStale': 'Версия профиля S3 изменилась. Сначала выполните повторное согласование политики.',
  'resources.preheat.policy.disabled.blocked': 'Сервер сейчас блокирует включение: {reason}',
  ...
  'resources.preheat.confirm.flow.workers': '{model} -> S3-профиль {profile} -> целевые воркеры',
  'resources.preheat.confirm.flow.artifact': 'Фиксированный S3 Artifact {model} -> целевые воркеры этого кластера',
  'resources.preheat.confirm.targetCount': 'Целевые воркеры',
  'resources.preheat.confirm.targetPending': 'Определяется при выполнении по диапазону GPU',
  'resources.preheat.confirm.capacity': 'Доступная ёмкость',
  'resources.preheat.confirm.capacityUnavailable': 'Воркеры не передали сведения о ёмкости',
  'resources.preheat.confirm.artifactSize': 'Размер модели S3',
  'resources.preheat.confirm.skipRule': 'Правило пропуска',
  'resources.preheat.confirm.skipRuleValue': 'Файлы с тем же хешем пропускаются.',
  'resources.preheat.confirm.conflictRule': 'Правило замены/конфликта',
  'resources.preheat.confirm.conflictRuleValue': 'Файлы с другим хешем заменяются; сервер обрабатывает конфликты по правилам идемпотентности и lease.',
  'resources.preheat.confirm.conflictRuleValue.s3_only': 'Конфликтующее содержимое с тем же Artifact ID изолируется или отклоняется; общий S3 Artifact не перезаписывается.',
  'resources.preheat.confirm.conflictRuleValue.workers': 'Файлы с другим хешем на целевых воркерах заменяются по правилам идемпотентности и lease сервера.',
  'resources.preheat.confirm.conflictRuleValue.artifact': 'Фиксированный Artifact устанавливается только на целевые воркеры; конфликты файлов обрабатываются по правилам идемпотентности и lease сервера.',
  'resources.storage.taskProgress': 'Ход выполнения', 'resources.storage.startedAt': 'Начато', 'resources.storage.finishedAt': 'Завершено', 'resources.storage.taskTimeline': 'Хронология',
  'resources.preheat.schedule.preset.manual': 'Вручную', 'resources.preheat.schedule.preset.hourly': 'Каждый час', 'resources.preheat.schedule.preset.daily': 'Каждый день', 'resources.preheat.schedule.preset.weekly': 'Каждую неделю', 'resources.preheat.schedule.preset.custom': 'Пользовательский Cron', 'resources.preheat.schedule.time': 'Время запуска', 'resources.preheat.schedule.weekday': 'День недели',
  'resources.preheat.schedule.weekday.0': 'Воскресенье', 'resources.preheat.schedule.weekday.1': 'Понедельник', 'resources.preheat.schedule.weekday.2': 'Вторник', 'resources.preheat.schedule.weekday.3': 'Среда', 'resources.preheat.schedule.weekday.4': 'Четверг', 'resources.preheat.schedule.weekday.5': 'Пятница', 'resources.preheat.schedule.weekday.6': 'Суббота',
  'resources.preheat.schedule.preset.continuous': 'Непрерывное заполнение', 'resources.preheat.schedule.summary.label': 'Сводка расписания', 'resources.preheat.schedule.summary.manual': 'Запуск вручную', 'resources.preheat.schedule.summary.continuous': 'Непрерывная сверка', 'resources.preheat.schedule.summary.hourly': 'Запуск каждый час', 'resources.preheat.schedule.summary.daily': 'Запуск каждый день в {time}', 'resources.preheat.schedule.summary.weekly': 'Запуск каждый {weekday} в {time}', 'resources.preheat.schedule.summary.custom': 'Пользовательский Cron: {cron}', 'resources.preheat.schedule.nextRuns': 'Следующие три запуска', 'resources.preheat.schedule.nextRunsUnavailable': 'Предпросмотр в клиенте недоступен',
  'resources.storage.totalSize': 'Общий размер', 'resources.storage.stateMessage': 'Сообщение состояния', 'resources.storage.taskState.paused': 'Приостановлено', 'resources.storage.taskState.partial': 'Частично завершено', 'resources.storage.taskState.unknown': 'Неизвестное состояние', 'resources.storage.syncTask.state.running': 'Выполняется'
};
