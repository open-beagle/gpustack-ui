export default {
  ...
  'resources.preheat.workerRole': 'Role',
  'resources.preheat.workerRole.seed': 'Preheat',
  'resources.preheat.workerRole.distribute': 'Distribute',
  'resources.preheat.workerRole.connectivity_check': 'Connectivity',
  ...
  'resources.preheat.nodeCount': 'Nodes',
  ...
  'resources.preheat.schedule.triggerMode.continuous': 'Continuous',
  ...
  'resources.storage.lastVerifiedAt': 'Last verified',
  'resources.storage.lastScan': 'Last scan',
  'resources.storage.scanAttemptAt': 'Attempted',
