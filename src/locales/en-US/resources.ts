export default {
  ...
  'resources.modelcache.title': 'Model Cache',
  'resources.modelcache.cached': 'Cached',
  ...
  'resources.modelcache.deleteCache': 'Delete Cache',
  'resources.modelcache.deleteCache.content':
    '{model} · {files} files · {size}',
  'resources.modelcache.deleteTask': 'Delete Cache Task',
  ...
  'resources.modelcache.deleteTask.finished':
    'Only task #{id} is deleted. A completed model cache is not removed.',
